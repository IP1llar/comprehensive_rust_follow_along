...
// arguments. They are distinguished by a `!` at the end. 
// For example:
// - `println!(format, ...)` prints a line to standard output, applying formatting described in
// `std::fmt`.
// - `format!(format, ..)` works just like `println!` but returns the result as a string.
// - `dbg!(expression)` logs the value of the expression and returns it.
// - `todo!()` marks a but of code as not-yet-implemented. If executed, it will panic.
