...
// undefined behavior under any any arbitrary circumstances
//
...
// prohibit this with `#[deny(unsafe_op_in_unsafe_fn)]`. This will likely change in a future Rust
// edition
